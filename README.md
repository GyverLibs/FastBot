...
- Для того, чтобы бот читал все сообщения в группе (а не только команды), нужно отключить параметр *Group Privacy* в настройках бота (*Bot Settings*) в чате с *@BotFather*.
